...
for low in range(len(lows)):
    for high in range(len(highs)):
        ...
        plt.savefig('/home/achanna/projects/rrg-bojana/achanna/kylie_edits/unresampled_plots/' + lowlows[low] + highhighs[high] + '_frac_nice_scaled_dropmice.png', bbox_inches='tight')
