...
for date in megapwrspdf['date'].unique():
    ...
    plt.savefig('/home/achanna/projects/rrg-bojana/achanna/kylie_edits/unresampled_plots/' +date + '_powspec_dropmice.png', bbox_inches='tight')
...
for freq in range(len(powspecfrqs)-1):
    ...
    plt.savefig('/home/achanna/projects/rrg-bojana/achanna/kylie_edits/unresampled_plots/' +powspecbands[freq] + '_frac_nice_dropmice.png', bbox_inches='tight')
...
for freq in range(len(powspecfrqs)-1):
    ...
    plt.savefig('/home/achanna/projects/rrg-bojana/achanna/kylie_edits/unresampled_plots/' +powspecbands[freq] + '_frac_mouseavg_dropmice.png', bbox_inches='tight')
...
for low in range(len(lows)):
    for high in range(len(highs)):
        ...
        plt.savefig('/home/achanna/projects/rrg-bojana/achanna/kylie_edits/unresampled_plots/' + lowlows[low] + highhighs[high] + '_frac_mouseavg_scaled_dropmice.png', bbox_inches='tight')
